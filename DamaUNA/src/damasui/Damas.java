...
public class Damas extends JFrame {
	...
	public Damas() {
		...
		JMenu menuConexao = new JMenu("Conex�o");
				...
				public void actionPerformed( ActionEvent e){
					...
					try{
						intPorta = Integer.parseInt(JOptionPane.showInputDialog(null,
						                            "Informe a porta para estabelecer a comunica��o?",
						                            "Porta do Servidor",
													JOptionPane.QUESTION_MESSAGE));
					}
					catch ( NumberFormatException nfe ) {
						JOptionPane.showMessageDialog(jogo.tabuleiro, "Porta Inv�lida", "Erro", JOptionPane.ERROR_MESSAGE);
						intPorta = -1;
						//nfe.printStackTrace();
		            }
		...
		mItemCliente.addActionListener( 
			new ActionListener(){
				public void actionPerformed( ActionEvent e){
					...
					try{
						intPorta = Integer.parseInt(JOptionPane.showInputDialog(null,
						                            "Informe a porta para estabelecer a comunica��o com o Servidor",
						                            "Porta do Servidor",
													JOptionPane.QUESTION_MESSAGE));
					}
					catch ( NumberFormatException nfe ) {
